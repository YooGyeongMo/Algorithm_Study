...
네트워크에 연결되어 있는 컴퓨터들은 각각 하나의 IP 주소를 갖게 된다. 그리고 이러한 IP 주소를 갖는 컴퓨터들이 여러 개 모여서 하나의 IP 네트워크를 구성하게 된다. IP 네트워크는 &lsquo;네트워크 주소&rsquo;와 &lsquo;네트워크 마스크&rsquo;라는 두 개의 정보로 표현된다.
